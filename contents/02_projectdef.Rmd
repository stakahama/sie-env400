...
3. Contrast the weeday and weekend differences in diurnal (hourly)
...
been calculated.
4. Describe periods which lie out of usual patterns.
...
6. Which variables show mild to strong correlations with each other for a) which sites and b) which time periods?
