...
```{r, include=FALSE}
library(knitr)
opts_chunk$set(fig.path='figures_rmd/lec01_', fig.align='center')
```
...
<center><img src="./figures/NABEL_Network.png" alt="from _Stations de mesure NABEL_" width="50%"/></center>
