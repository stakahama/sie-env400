...
In hourly concentrations plotted below for 2013 in Junfraujoch (JUN), Lausanne (LAU), Payerne (PAY), and Zurich (ZUE), we can identify several extreme values. We will particularly focus on the PM$_{10}$ and EC concentrations in Zurich and examine them further.
<center>
<figure>
<img src="./figures/view_unnamed-chunk-10.png">
</figure>
</center>
...
For statistical treatment of this topic, see @Barnett1994 from which much of this material has been taken.
...
<center>
<figure>
<img src="./figures/Barnett_Fig_2-1.png"/>
</figure>
<figcaption>
[@Barnett1994]
</figcaption>
...
<tr style="border-bottom: 1px solid #000;"> 
<td> reject $H_0$ </td><td> \emph{Type I error} ($\alpha$) </td><td> Correct decision  </td>
<tr style="border-bottom: 1px solid #000;">
<td> do not reject $H_0$ </td><td> Correct decision </td><td> \emph{Type II error}  ($\beta$) </td>
</tr>
</table>
</center>
<br>
...
## Accommodating outliers [@Venables2003]


*Why will it not suffice to screen data and remove outliers?*
...
As a rather uninteresting example, we can use a trimmed mean as a robust estimator of the mean. Notice that the mean is less influenced by the presence of extreme values. (Note that 10\% corresponds to $\ceil{24\times{}.1}=2$ observations removed.)
